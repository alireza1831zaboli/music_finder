...
first_button = types.InlineKeyboardButton("ارتباط با ما", url="https://t.me/alireza18z31")  
...
def process_song_name_2(message):
    ...
    bot.register_next_step_handler(message, lambda msg: process_song_artist(msg, song_name))
